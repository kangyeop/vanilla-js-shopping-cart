...
eval("module.exports = __webpack_require__(/*! ./lib/axios */ \"./node_modules/axios/lib/axios.js\");\n\n//# sourceURL=webpack://shopping-cart/./node_modules/axios/index.js?");
...
"use strict";
eval("\n\n/**\n * A `Cancel` is an object that is thrown when an operation is canceled.\n *\n * @class\n * @param {string=} message The message.\n */\nfunction Cancel(message) {\n  this.message = message;\n}\n\nCancel.prototype.toString = function toString() {\n  return 'Cancel' + (this.message ? ': ' + this.message : '');\n};\n\nCancel.prototype.__CANCEL__ = true;\n\nmodule.exports = Cancel;\n\n\n//# sourceURL=webpack://shopping-cart/./node_modules/axios/lib/cancel/Cancel.js?");
...
"use strict";
eval("\n\nmodule.exports = function isCancel(value) {\n  return !!(value && value.__CANCEL__);\n};\n\n\n//# sourceURL=webpack://shopping-cart/./node_modules/axios/lib/cancel/isCancel.js?");
...
"use strict";
eval("\n\nvar utils = __webpack_require__(/*! ./../utils */ \"./node_modules/axios/lib/utils.js\");\n\n/**\n * Transform the data for a request or a response\n *\n * @param {Object|String} data The data to be transformed\n * @param {Array} headers The headers for the request or response\n * @param {Array|Function} fns A single function or Array of functions\n * @returns {*} The resulting transformed data\n */\nmodule.exports = function transformData(data, headers, fns) {\n  /*eslint no-param-reassign:0*/\n  utils.forEach(fns, function transform(fn) {\n    data = fn(data, headers);\n  });\n\n  return data;\n};\n\n\n//# sourceURL=webpack://shopping-cart/./node_modules/axios/lib/core/transformData.js?");
...
"use strict";
eval("\n\nmodule.exports = function bind(fn, thisArg) {\n  return function wrap() {\n    var args = new Array(arguments.length);\n    for (var i = 0; i < args.length; i++) {\n      args[i] = arguments[i];\n    }\n    return fn.apply(thisArg, args);\n  };\n};\n\n\n//# sourceURL=webpack://shopping-cart/./node_modules/axios/lib/helpers/bind.js?");
...
"use strict";
eval("\n\n/**\n * Creates a new URL by combining the specified URLs\n *\n * @param {string} baseURL The base URL\n * @param {string} relativeURL The relative URL\n * @returns {string} The combined URL\n */\nmodule.exports = function combineURLs(baseURL, relativeURL) {\n  return relativeURL\n    ? baseURL.replace(/\\/+$/, '') + '/' + relativeURL.replace(/^\\/+/, '')\n    : baseURL;\n};\n\n\n//# sourceURL=webpack://shopping-cart/./node_modules/axios/lib/helpers/combineURLs.js?");
...
"use strict";
eval("\n\n/**\n * Determines whether the payload is an error thrown by Axios\n *\n * @param {*} payload The value to test\n * @returns {boolean} True if the payload is an error thrown by Axios, otherwise false\n */\nmodule.exports = function isAxiosError(payload) {\n  return (typeof payload === 'object') && (payload.isAxiosError === true);\n};\n\n\n//# sourceURL=webpack://shopping-cart/./node_modules/axios/lib/helpers/isAxiosError.js?");
...
"use strict";
eval("\n\nvar utils = __webpack_require__(/*! ../utils */ \"./node_modules/axios/lib/utils.js\");\n\nmodule.exports = function normalizeHeaderName(headers, normalizedName) {\n  utils.forEach(headers, function processHeader(value, name) {\n    if (name !== normalizedName && name.toUpperCase() === normalizedName.toUpperCase()) {\n      headers[normalizedName] = value;\n      delete headers[name];\n    }\n  });\n};\n\n\n//# sourceURL=webpack://shopping-cart/./node_modules/axios/lib/helpers/normalizeHeaderName.js?");
...
"use strict";
eval("\n\n/**\n * Syntactic sugar for invoking a function and expanding an array for arguments.\n *\n * Common use case would be to use `Function.prototype.apply`.\n *\n *  ```js\n *  function f(x, y, z) {}\n *  var args = [1, 2, 3];\n *  f.apply(null, args);\n *  ```\n *\n * With `spread` this example can be re-written.\n *\n *  ```js\n *  spread(function(x, y, z) {})([1, 2, 3]);\n *  ```\n *\n * @param {Function} callback\n * @returns {Function}\n */\nmodule.exports = function spread(callback) {\n  return function wrap(arr) {\n    return callback.apply(null, arr);\n  };\n};\n\n\n//# sourceURL=webpack://shopping-cart/./node_modules/axios/lib/helpers/spread.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + \"81302793578cc4c93a901ea3a5d25743.svg\");\n\n//# sourceURL=webpack://shopping-cart/./src/images/logo.svg?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"getImages\": () => (/* binding */ getImages)\n/* harmony export */ });\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../config */ \"./src/config.js\");\n\n\n\nconst getImages = async (query) => {\n    const res = await axios__WEBPACK_IMPORTED_MODULE_0___default().get(_config__WEBPACK_IMPORTED_MODULE_1__.config.apiUrl, {\n        method: \"get\",\n        params: { query, page: 1 },\n        headers: { Authorization: _config__WEBPACK_IMPORTED_MODULE_1__.config.apiKey },\n    });\n    return res;\n};\n\n\n//# sourceURL=webpack://shopping-cart/./src/api/index.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ App)\n/* harmony export */ });\n/* harmony import */ var _header__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./header */ \"./src/components/header.js\");\n/* harmony import */ var _ad__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ad */ \"./src/components/ad.js\");\n/* harmony import */ var _products__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./products */ \"./src/components/products.js\");\n/* harmony import */ var _cart__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./cart */ \"./src/components/cart.js\");\n\n\n\n\n\nclass App {\n    constructor(app) {\n        const onClickCart = () => {\n            this.setIsShow();\n        };\n\n        this.initData();\n\n        const header = new _header__WEBPACK_IMPORTED_MODULE_0__.default(app, onClickCart);\n        this.header = header;\n\n        const adSection = new _ad__WEBPACK_IMPORTED_MODULE_1__.default(app);\n        this.adSection = adSection;\n\n        const productSection = new _products__WEBPACK_IMPORTED_MODULE_2__.default(app, this.ids, onClickCart);\n        this.productSection = productSection;\n\n        const cartSection = new _cart__WEBPACK_IMPORTED_MODULE_3__.default(app, onClickCart);\n        this.cartSection = cartSection;\n    }\n\n    setIsShow() {\n        this.isShow = !this.isShow;\n        this.cartSection.show(this.isShow);\n    }\n\n    initData() {\n        const idsJson = localStorage.getItem(\"cartIds\");\n\n        const ids = JSON.parse(idsJson);\n\n        if (ids) {\n            this.ids = ids;\n        } else {\n            this.ids = [];\n            localStorage.setItem(\"cartIds\", \"[]\");\n        }\n    }\n}\n\n\n//# sourceURL=webpack://shopping-cart/./src/components/app.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"config\": () => (/* binding */ config)\n/* harmony export */ });\nconst config = {\n    apiUrl: \"https://api.pexels.com/v1/search\",\n    apiKey: \"563492ad6f91700001000001ec016692316f48eea23e5d2bb1f5668f\",\n};\n\n\n//# sourceURL=webpack://shopping-cart/./src/config.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"setHeaderCount\": () => (/* binding */ setHeaderCount),\n/* harmony export */   \"setTotalPrice\": () => (/* binding */ setTotalPrice)\n/* harmony export */ });\n/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils */ \"./src/utils/index.js\");\n\n\nconst setHeaderCount = () => {\n    const ids = JSON.parse(localStorage.getItem(\"cartIds\"));\n    const count = ids.length;\n\n    const countBox = document.querySelector(`.cart-count-box`);\n    if (count > 0) {\n        countBox.classList.remove(\"hidden\");\n        countBox.textContent = count;\n    } else {\n        countBox.classList.add(\"hidden\");\n    }\n};\n\nconst setTotalPrice = () => {\n    const idsJson = localStorage.getItem(\"cartIds\");\n    const dataJson = localStorage.getItem(\"data\");\n\n    const ids = JSON.parse(idsJson);\n    const data = JSON.parse(dataJson);\n\n    if (ids) {\n        let count = 0;\n        ids.forEach((id) => {\n            const res = data.find((item) => item.id === id);\n            count += res.id;\n        });\n\n        const totalPrice = document.querySelector(\"#total-price\");\n\n        totalPrice.textContent = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.numberWithCommas)(count);\n    }\n};\n\n\n//# sourceURL=webpack://shopping-cart/./src/lib/index.js?");
